...
public interface JwtService {
    ...
    void sendAccessAndRefreshToken(HttpServletResponse response, String accessToeken, String refreshToken);
    ...
    String returnUserSocialType(String username);

    String returnUserRole(String username);
}
